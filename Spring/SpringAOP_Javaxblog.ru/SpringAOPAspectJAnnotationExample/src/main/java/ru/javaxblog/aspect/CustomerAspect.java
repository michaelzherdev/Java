...
public class CustomerAspect {
	...
	@AfterReturning(
			pointcut = "execution(* ru.javaxblog.customer.services.CustomerService.addCustomerReturnValue(..))",
			returning= "result")
	...
	@AfterThrowing(
			pointcut = "execution(* ru.javaxblog.customer.services.CustomerService.addCustomerThrowException(..))",
			throwing= "error")
